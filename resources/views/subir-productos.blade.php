...
@section('contenido')
    <div class=" flex items-center justify-center">
        <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4" method="POST"
            ...
            <br>
            <h1 class="block text-gray-700 font-bold mb-2 text-xl text-center">Subir articulo a la aplicacíon de smartshop.
            </h1>
            <br>
            <div class="mb-4">
                ...
                <input
                    ...
                    name="nombre" type="text" placeholder="Ingresa el nombre" value="{{ old('nombre') }}" @error('nombre')
                    is-valid @enderror>
                @error('nombre')
                    <h5>{{ $message }}</h5>
                @enderror
            ...
            <div class="mb-4">
                ...
                <textarea
                    ...
                    name="descripcion" type="text" placeholder="Agrega la descripción del producto"
                    value="{{ old('descripcion') }}" @error('descripcion') is-valid
                        @enderror></textarea>@error('descripcion')
                    <h5>{{ $message }}</h5>
                @enderror
            </div>
            ...
            <div class="mb-4">
                ...
                <select type="text" name="sucursal"
                    class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
            ...
            <div class="mb-4">
                ...
                <input
                    class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                    name="precio" type="number" step="any" placeholder="Ingresa el precio" value="{{ old('precio') }}"
                    @error('precio') is-valid @enderror>
                @error('precio')
                    <h5>{{ $message }}</h5>
                @enderror
            </div>
            ...
            <div class="mb-4">
                ...
                <input
                    class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                    name="archivo" type="text" placeholder="Link de la imagen" value="{{ old('archivo') }}"
                    @error('archivo') is-valid @enderror>
                @error('archivo')
                    <h5>{{ $message }}</h5>
                @enderror
            </div>
